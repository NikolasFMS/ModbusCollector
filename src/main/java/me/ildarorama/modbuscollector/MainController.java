...
public class MainController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        TableColumn<DeviceResponse, String> column1 = new TableColumn<>(
            PARAMS.get(0)
        );
        column1.setCellValueFactory(new PropertyValueFactory<>("a1"));
        tblData.getColumns().add(column1);

        TableColumn<DeviceResponse, String> column2 = new TableColumn<>(
            PARAMS.get(1)
        );
        column2.setCellValueFactory(new PropertyValueFactory<>("a2"));
        tblData.getColumns().add(column2);

        TableColumn<DeviceResponse, String> column3 = new TableColumn<>(
            PARAMS.get(2)
        );
        column3.setCellValueFactory(new PropertyValueFactory<>("a3"));
        tblData.getColumns().add(column3);

        TableColumn<DeviceResponse, String> column4 = new TableColumn<>(
            PARAMS.get(3)
        );
        column4.setCellValueFactory(new PropertyValueFactory<>("a4"));
        tblData.getColumns().add(column4);

        TableColumn<DeviceResponse, String> column5 = new TableColumn<>(
            PARAMS.get(4)
        );
        column5.setCellValueFactory(new PropertyValueFactory<>("a5"));
        tblData.getColumns().add(column5);

        TableColumn<DeviceResponse, String> column6 = new TableColumn<>(
            PARAMS.get(5)
        );
        column6.setCellValueFactory(new PropertyValueFactory<>("a6"));
        tblData.getColumns().add(column6);

        TableColumn<DeviceResponse, String> column7 = new TableColumn<>(
            PARAMS.get(6)
        );
        column7.setCellValueFactory(new PropertyValueFactory<>("a7"));
        tblData.getColumns().add(column7);

        TableColumn<DeviceResponse, String> column8 = new TableColumn<>(
            PARAMS.get(7)
        );
        column8.setCellValueFactory(new PropertyValueFactory<>("a8"));
        tblData.getColumns().add(column8);

        TableColumn<DeviceResponse, String> column9 = new TableColumn<>(
            PARAMS.get(8)
        );
        column9.setCellValueFactory(new PropertyValueFactory<>("a9"));
        tblData.getColumns().add(column9);

        TableColumn<DeviceResponse, String> column10 = new TableColumn<>(
            PARAMS.get(9)
        );
        column10.setCellValueFactory(new PropertyValueFactory<>("a10"));
        tblData.getColumns().add(column10);
